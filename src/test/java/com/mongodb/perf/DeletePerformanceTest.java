...
public class DeletePerformanceTest {
    ...
    @Test
    public void testPerformanceOfDeleteForSingleDocumentWithSingleStringField() {
        // Given
        ...
        System.out.printf("Delete Single Document,%.0f,%d, %n", operationsPerSecond, timeTaken);
    }
